...
export interface ApiEventInquiryEventInquiry
  extends Struct.CollectionTypeSchema {
  collectionName: 'event_inquiries';
  info: {
    description: 'Lead submissions from the website contact form';
    displayName: 'Event Inquiry';
    pluralName: 'event-inquiries';
    singularName: 'event-inquiry';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['Wedding', 'Corporate', 'Concert', 'Conference', 'Exhibition', 'Other']
    > &
      Schema.Attribute.DefaultTo<'Other'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-inquiry.event-inquiry'
    > &
      Schema.Attribute.Private;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide contact info and branding';
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    fallbackPosterImage: Schema.Attribute.Media<'images'>;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Uploadable PDFs (brochures, portfolios, rate cards) for use in CTA links';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Brochure', 'Portfolio', 'Rate Card', 'Other']
    > &
      Schema.Attribute.DefaultTo<'Other'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSiteStatSiteStat extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage event metrics counters';
  ...
  attributes: {
    concertsCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    conferencesCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    corporateEventsCount: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exhibitionsCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weddingsCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
  };
}
